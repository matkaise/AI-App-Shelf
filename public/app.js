...
function updateEditorTitle() {
  ...
  els.editorTitle.textContent = name || "HTML einfügen";
}
...
async function saveCurrentApp(event) {
  ...
  if (!payload.name || !payload.code.trim()) {
    showToast("Name und HTML sind erforderlich.", true);
    return;
  }
...
function updatePreview() {
  ...
  els.previewFrame.srcdoc = els.codeInput.value || "<!doctype html><html><body></body></html>";
}
